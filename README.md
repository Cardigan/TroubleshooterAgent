...
Please install these where my Copilot CLI (or other ai agent CLI) will pick them up. If the user is using a differnt Agent CLI please adapt the installation accordingly. Confirm what you installed all the skills, agents, instructions and where, and clean up any temp clone.
```
